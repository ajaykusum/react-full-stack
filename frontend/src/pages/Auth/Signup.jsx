...
const Signup = () => {
  ...
  const handleSubmit = (e) =>{
    e.preventDefault()
    axios.post("http://localhost:3000/api/user/createUser",{Name, email, password})
            ...
            >
                ...
                <div className='p-10 bg-white'>
                    ...
                    <div className='flex flex-col mb-4'>
                            <label className='text-slate-500 font-semibold mb-2' htmlFor="text">Name</label>
                            <input
                                type="text"
                                id='name'
                                name='name'
                        ...
                        <button type='submit' className='p-2 my-4 text-center w-full bg-indigo-500 hover:bg-indigo-400 text-white rounded'>Create Account</button>
